...
contract NFTMarketplace is ERC721URIStorage{
    ...
    // Let crete "CREATE NFT TOKEN FUNCTION"
    ...
    function createMarketItem(uint256 tokenId, uint256 price) private{
        ...
        require(msg.value == listingPrice, "Price must be equal to listin... ");
    ...
    function createMarketSale(uint256 tokenId) public payable{
        ...
        require(
                msg.value == price,
                "Please submit the asking price in order to complete the process"
                );
